...
class DefaultEntityRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\custom_entity\Entity\DefaultEntityInterface
   */
  protected $revision;
   ...
   *
   * @param \Drupal\custom_entity\Entity\DefaultEntityInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\custom_entity\Entity\DefaultEntityInterface
